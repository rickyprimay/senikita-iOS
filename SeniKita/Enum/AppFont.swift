...
struct AppFont {
    ...
    struct Raleway {
        ...
        static let bodyLarge = Font.custom("Raleway-Medium", size: 17)
    ...
    struct Crimson {
        ...
        static let bodyLarge = Font.custom("CrimsonPro-Regular", size: 17)
    ...
    struct Nunito {
        ...
        static let bodyLarge = Font.custom("Nunito-Regular", size: 17)
